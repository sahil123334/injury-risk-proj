...
LEFT_LEG_LANDMARKS = [LEFT_HIP, LEFT_KNEE, LEFT_ANKLE]
RIGHT_LEG_LANDMARKS = [RIGHT_HIP, RIGHT_KNEE, RIGHT_ANKLE]
LOWER_BODY_LANDMARKS = LEFT_LEG_LANDMARKS + RIGHT_LEG_LANDMARKS
